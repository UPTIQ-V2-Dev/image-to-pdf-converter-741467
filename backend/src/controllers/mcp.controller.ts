...
import { conversionTools } from '../tools/conversion.tool.ts';
import { statisticsTools } from '../tools/statistics.tool.ts';
...
export const mcpPostController = catchAsync(async (req: Request, res: Response) => {
    ...
    if (sessionId && transports[sessionId]) {
        ...
        registerMCPTools({ server, tools: [...userTools, ...conversionTools, ...statisticsTools] });
