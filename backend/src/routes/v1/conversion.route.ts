import { conversionController } from '../../controllers/index.ts';
import auth from '../../middlewares/auth.ts';
import validate from '../../middlewares/validate.ts';
import { conversionValidation } from '../../validations/index.ts';
...
router
    .route('/')
    .post(
        auth('manageConversions'),
        validate(conversionValidation.createConversion),
...
router
    ...
    .delete(
        auth('manageConversions'),
        validate(conversionValidation.deleteConversion),
...
router
    ...
    .post(
        auth('manageConversions'),
        validate(conversionValidation.processConversion),
        conversionController.processConversion
    );
...
router
    ...
    .get(
        auth('getConversions'),
        validate(conversionValidation.downloadConversion),
        conversionController.downloadConversion
    );
...
router
    ...
    .get(
        auth('getConversions'),
        validate(conversionValidation.getConversionProgress),
        conversionController.getConversionProgress
    );
